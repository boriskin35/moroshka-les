export const Icons = {
  groups: {
    ...
    class: 'mt-1 h-8 w-8 shrink-0 fill-accent dark:fill-accent',
    width: 48,
    height: 48,
  ...
  tools: {
    ...
    class:
      'mt-2 h-6 w-6 shrink-0 fill-neutral-700 hs-tab-active:fill-accent dark:fill-neutral-300 dark:hs-tab-active:fill-orange-300 md:h-7 md:w-7',
    width: 48,
    height: 48,
    viewBox: '0 -960 960 960',
  },
  ...
  house: {
    ...
    class:
      'h-6 w-6 shrink-0 text-neutral-700 hs-tab-active:text-accent dark:text-neutral-300 dark:hs-tab-active:text-orange-300 md:h-7 md:w-7',
    width: 24,
    height: 24,
    viewBox: '0 0 24 24',
    fill: 'none',
  ...
  arrowUp: {
    ...
    class: 'h-5 w-5 shrink-0 text-accent dark:text-accent',
    width: 24,
    height: 24,
    viewBox: '0 0 24 24',
    fill: 'none',
  ...
  phone: {
    ...
    class: 'mt-1.5 h-6 w-6 shrink-0 text-accent dark:text-accent',
    viewBox: '0 0 24 24',
    fill: 'none',
    strokeWidth: '1.5',
    strokeLinecap: 'round',
  ...
  telegramFooter: {
    paths: [
      {
        d: 'M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.894 8.221-1.97 9.28c-.145.658-.537.818-1.084.508l-3-2.21-1.446 1.394c-.16.16-.295.295-.6.295l.213-3.054 5.56-5.022c.24-.213-.054-.334-.373-.12l-6.893 4.326-2.97-.945c-.643-.2-.658-.643.135-.954l11.6-4.458c.538-.196 1.006.12.832.941z',
      },
    ],
    class:
      'h-4 w-4 shrink-0 fill-current text-neutral-700 dark:text-neutral-400',
